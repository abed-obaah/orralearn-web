...
const Card = ({ item }) => {
  return (
    <div
      className={`w-full rounded-3xl bg-white  p-6 font-openSans flex  gap-4 `}
    >
      <div
        className={`rounded-3xl w-full  max-w-[200px] h-72 flex flex-col gap-y-4 px-4  ${item.bgColr} pt-5`}
      >
      ...
      <div className={" flex flex-col justify-between"}>
        ...
        <div className={"flex items-center gap-4"}>
          <span className={"text-[#555555] text-opacity-40"}>
            {item.oldPrice}
          </span>
          <span className={"text-black"}>{item.newPrice}</span>
        </div>
        <Link to={""} className={`${styles.buttonStyleTwo} w-40`}>
          Buy Now
        </Link>
      </div>
    </div>
...
const Dashboard = () => {
  const webiners = [
    {
      logo: (
        ...
        >
          <path
            d="M12.6367 21.741V22.741"
            stroke="white"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M19.707 5.66968L18.9999 6.37678"
            stroke="white"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M6.27344 19.1052L5.56633 19.8123"
            stroke="white"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M22.6367 12.741L21.6367 12.741"
            stroke="white"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M19.707 19.8123L18.9999 19.1051"
            stroke="white"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
          <path
            d="M2.63672 12.741C2.63672 18.2638 7.11387 22.741 12.6367 22.741C18.1596 22.741 22.6367 18.2638 22.6367 12.741C22.6367 7.21812 18.1596 2.74097 12.6367 2.74097M2.63672 12.741C2.63672 7.21812 7.11387 2.74097 12.6367 2.74097M2.63672 12.741H3.63672M12.6367 2.74097V3.74097M6.27271 6.37701L5.5656 5.66991M12.6367 18.741C10.0243 18.741 7.8018 17.0714 6.97813 14.741H18.2953C17.4716 17.0714 15.2492 18.741 12.6367 18.741ZM12.6367 6.74097C15.2492 6.74097 17.4716 8.41058 18.2953 10.741L6.97813 10.741C7.8018 8.41058 10.0243 6.74097 12.6367 6.74097Z"
            stroke="white"
            stroke-width="1.5"
      ...
      title: "JavaScipt Beginners Guide",
      time: "10:00 - 11:30",
    },
    {
      logo: (
      ...
      title: "Meeting with ATO Bradley",
      time: "11:40 - 01:00",
    },
    {
      logo: (
        ...
        >
          <path
            d="M8.63672 2.00696H16.6367M6.63672 12.007H18.6367M10.6367 2.00696H14.6367V8.29684C17.5282 9.15739 19.6367 11.8359 19.6367 15.007C19.6367 18.873 16.5027 22.007 12.6367 22.007C8.77073 22.007 5.63672 18.873 5.63672 15.007C5.63672 11.8359 7.74523 9.15739 10.6367 8.29684L10.6367 2.00696Z"
            stroke="white"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
  ...
  const reusabletextStyle =
    "text-[13px] text-black  text-opacity-70 font-openSans";
  ...
  return (
    <div className={`w-full h-full flex  gap-10 gap-y-10 font-openSans`}>
      <div className={` flex flex-col w-3/5 gap-y-10   `}>
        <div
          className={
            "flex items-center font-openSans  rounded-[20px]   h-[200px] w-full bgFour p-5 "
          }
        >
          <div className={"w-3/5 "}>
            ...
            <p className={"text-white text-[15px] tracking-[0.3]"}>
              You've just started your journey with us, and we're excited to
              have you on board.
            </p>
          </div>
        ...
        <div className={`${genContainerStyle} boxShadowOne`}>
          <div className={`${reusableContainerHeading}`}>
            <h1 className={`${reusableHeadingStyles}`}>
              Upcoming Course just for you
            </h1>
          </div>
        ...
        <div className={`${genContainerStyle}`}>
          <div className={`${reusableContainerHeading}`}>
            ...
            <p className={"text-[#555555] text-opacity-70"}>
          ...
          <div className={"grid grid-cols-2 gap-4"}>
            <div
              className={
                "w-full rounded-3xl bg-white  p-6 font-openSans flex  gap-4"
              }
            >
              <div
                className={
                  "rounded-3xl max-w-[200px] flex flex-col h-72 items-center  bg-[#FCC52A] pt-5"
                }
              >
                <div className={"full bg-black p-2"}>
                  <p className={"text-[#FF9B26] text-center font-semibold"}>
                    Full-Stack Web Development in 2 weeks
                  </p>
                </div>
                <div className={"my-10"}>
                  <img src={hcj} alt={""} />
                ...
                <div
                  className={
                    "w-full bg-black text-[#FF9B26] text-center rounded-b-3xl font-semibold py-2 text-xs"
                  }
                >
                  {" "}
                  BY ATO Bradley
              ...
              <div className={" flex flex-col justify-between"}>
                <div className={"flex flex-col gap-y-2"}>
                  <h1 className={"text-[#5E00D0] text-[14px]"}>Programming</h1>
                  <p className={"font-semibold text-black text-opacity-80"}>
                    Full Stack web <br /> Development in 2 weeks
                  </p>
                </div>
                <div className={"flex items-center gap-4"}>
                  <span className={"text-[#555555] text-opacity-40"}>
            ...
            <div
              className={
                "bg-[#5E00D0] flex items-center justify-center rounded-3xl  gap-4 text-white font-openSans "
              }
            >
          ...
          <div className={`${genContainerStyle} boxShadowOne`} key={i}>
            ...
            <div className={"flex bg-white px-6 py-3 gap-6"}>
              ...
              <div className={"flex flex-col gap-y-4"}>
                ...
                <Link to={""} className={`${styles.buttonStyleTwo} w-56`}>
                  {item.button}
                </Link>
              </div>
            </div>
      ...
      <div className={"w-2/5  flex flex-col gap-y-10 font-openSans"}>
        <div
          className={
            "bg-[#F9FAFB] w-full min-h-[384px] flex flex-col gap-y-4 p-4 borderThree"
          }
        >
          <h1 className={`${styles.dashboardHeadingOne}`}>Upcoming Webiners</h1>
          <div className={"bg-[#FFC136] p-2 border-b-8 border-b-[#8338EC]"}>
            <h4 className={"text-white font-sans font-bold text-[15px]"}>
              Up-next
            </h4>
            <div
              className={
                "bg-white w-full flex gap-6 items-center py-5 px-2 font-openSans"
              }
            >
              <img src={googleMeet} alt={""} />
              <div className={"flex flex-col gap-y-1"}>
                <p
                  className={"text-[9px] text-black text-opacity-50 font-bold"}
                >
                  10:00 - 10:30
                </p>
                <p className={"ext-black text-opacity-80 font-bold"}>
                  Mastering Web Development in 2023
                </p>
                <p className={`${reusabletextStyle}`}>
                  Join us for an insightful journey into the world of web
                  development in 2023. Discover the latest trends, tools, and
                  best practices to become a proficient web developer
                </p>
              </div>
            </div>
          </div>
          <div className={"w-full font-openSans"}>
            <h1 className={"text-[12px] font-bold  text-[#615E83] mb-4"}>
              After
            </h1>
            <div className={"flex flex-col gap-y-5"}>
              {webiners.map((item, i) => (
                <div className={"flex items-center gap-4 shadow-lg"} key={i}>
                  <div
                    className={
                      "bg-[#8338EC]  h-12 w-12 flex items-center justify-center"
                    }
                  >
                    {item.logo}
                  </div>
                  <div className={"flex flex-col"}>
                    <p
                      className={
                        "text-[9px] text-black text-opacity-50 font-bold"
                      }
                    >
                      {item.time}
                    </p>
                    <p className={"text-[#615E83] font-bold text-[10px]"}>
                      {item.title}
                    </p>
                  </div>
                </div>
        ...
        <div className={"flex flex-col gap-y-4 p-4 bg-white borderThree"}>
          <div className={"flex items-center justify-between font-openSans"}>
            ...
            <Link to={"/"} className={"text-[#07F] text-[13px] font-bold"}>
              See all
            </Link>
          </div>
          <div className={"flex flex-col gap-y-10"}>
            {upcomming.map((item, i) => (
              <div
                className={`flex gap-2 rounded-[20px] font-openSans p-8 ${item.color}`}
                key={i}
              >
                {console.log(item)}
                <div className={"flex gap-2 items-center"}>
                  <div className={"flex items-center gap-4"}>
                    <div
                      className={`w-16 h-16 rounded-full flex justify-center items-center  ${item.figurebg} font-bold  text-white text-lg`}
                    >
                      {item.number}
                    </div>
                    <div className={"flex flex-col gap-y-2"}>
                      ...
                      <div
                        className={
                          "flex items-center gap-1 text-[9px] text-black text-opacity-50 font-bold"
                        }
                      >
                        <span>{item.date}</span>
                        <span
                          className={"w-2 h-2 bg-[#07F] rounded-full"}
                        ></span>
                        <span>{item.time}</span>
                      </div>
                      <p
