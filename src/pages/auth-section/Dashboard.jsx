...
const Dashboard = () => {
  const { userInfo, subscription } = useStateContext();
    ...
    <div className={`w-full h-full flex  gap-10 gap-y-10 font-openSans`}>
      <div className={` flex flex-col w-full gap-y-10   `}>
          ...
          <div className={"sm:w-3/5 "}>
            <div className={""}>
              <div className={"flex items-center gap-2 mb-3"}>
                <h1
                  className={
                    "text-white font-bold text-2xl sm:text-xl  xl:text-2xl"
                  }
                >
              ...
              <p
                className={
                  "text-white text-base sm:text-sm xl:text-sm tracking-[0.3]"
                }
              >
        ...
        <div className={`${genContainerStyle} boxShadowOne`}>
          ...
          <div
            className={
              "flex flex-col md:flex-row bg-white md:px-6 md:py-3 gap-6"
            }
          >
            {/*<div></div>*/}
            <img
            ...
            <div className={"flex flex-col gap-y-4 px-6 pb-3 lg:px-0 lg:pb-0"}>
              ...
              {!subscription.subscribed ? (
                <Link
                  to={"/pricing"}
                  className={`${styles.buttonStyleTwo} w-full md:w-40`}
                >
                  Pre-Enroll
                </Link>
              ) : (
        ...
        <div className={`${genContainerStyle}`}>
          ...
          <div className={"w-full flex items-center gap-4"}>
            <div
              className={
                "grid md:grid-cols-2 gap-4  gap-y-6 w-full  justify-items-center"
              }
            >
            ...
            <Link
              to={"/ebooks"}
              className={
                "bg-[#5E00D0] hidden sm:flex    items-center justify-center rounded-3xl  gap-4 text-white font-openSans h-full w-40 "
              }
            >
        ...
        {otherSections.map((item, i) => (
          <div className={`${genContainerStyle} boxShadowOne`} key={i}>
            ...
            >
              ...
              />
              <div
                className={"flex flex-col gap-y-4 px-6 pb-3 lg:px-0 lg:pb-0"}
              >
                ...
                {!subscription.subscribed ? (
                  <Link
                    to={"/pricing"}
                    className={`${styles.buttonStyleTwo} w-56`}
                  >
                    {item.button}
                  </Link>
                ) : (
                ...
                {/*<Link to={item.path} className={`${styles.buttonStyleTwo} w-56`}>{item.button}</Link>*/}
              </div>
            </div>
          </div>
        ))}
