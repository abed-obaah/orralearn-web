export const styles ={
    ...
    buttonStyle:"py-[10px] px-[16px] bg-[#5E00D0] button-box-shadow rounded-[8px] shrink-0 text-white text-[20px] flex items-center justify-center hover:bg-white hover:text-[#5E00D0] transition ease-out  duration-300",
