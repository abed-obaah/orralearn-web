        ...
        <header className='w-full flex items-center justify-between px-12 py-4'>
          ...
          <NavLink to='/projects' className='flex items-center justify-center gap-6'>
            ...
            <div className='flex flex-col items-start justify-start'>
              ...
              <AnimatePresence>
                {isTitle ? <> <motion.input key={"TitleInput"} type='text' className='px-3 py-2 rounded-md bg-transparent text-gray-400 text-base outline-none border-none'
                placeholder='Your Title' value={title} onChange={(e) => setTitle(e.target.value)}/>
              ...
              <div className='flex items-center justify-center px-3 -mt-2 gap-2'>
                ...
                <motion.p whileTap={{scale: 0.98}} className='text-[10px] bg-emerald-500 rounded-sm px-2 py-[1px] text-gray-600 font-semibold cursor-pointer'>
                  + Follow
                </motion.p>
                </div>
            </div>
        ...
        <div>
          ...
          <SplitPane split='vertical' minSize={500}>
            ...
            <div className='w-full h-full flex flex-col items-start justify-start'>
              ...
              value={html}
              height="600px"
              extensions={[javascript({ jsx: true })]}theme={"dark"}
