import {discount, products, shipping, subtotal, taxes, total} from "../../util/usefull-data.js";


const Cart = () => {
    return (
        <section aria-labelledby="summary-heading" className="  pt-[80px] pb-10 hidden w-full max-w-md flex-col bg-gray-50 lg:flex">
